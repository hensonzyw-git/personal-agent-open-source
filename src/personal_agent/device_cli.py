...
DEVICE_SURFACE_SCOPES: Final[frozenset[str]] = frozenset(
    {SELF_READ_SCOPE, SELF_REVOKE_SCOPE, DEVICE_MANAGE_SCOPE, "dal.resume.approve", "dal.read", "dal.request", "dal.prd.decide", "dal.delivery.decide", "dal.project.authorize"}
)
