"""Executor for `DAL-T-PLAN-XFIELD-001` fixture bodies.

Replays the `validate_plan_cross_fields` operation command under the pure
...
handler (validation precedes the record inside it), so the executor dispatches
exactly one call.
"""
...
from personal_agent_dal.machine.plan_cross_fields import validate_plan_cross_fields
